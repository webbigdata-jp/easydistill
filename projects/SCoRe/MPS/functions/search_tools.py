...
class SearchTools:
    ...
    _cache_file = None  # Will be set dynamically
    
    @staticmethod
    def set_cache_file_path(cache_file_path: str):
        """Set the cache file path"""
        SearchTools._cache_file = cache_file_path
        SearchTools._db_initialized = False  # Reset initialization flag
    ...
    def web_search(query):
        ...
        if search_dicts is None:
            ...
            retrieved_content = "Retrieved from cache.\n"
