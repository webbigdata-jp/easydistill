...
from graph import run_agent_repair
from functions import SearchTools

def main():
    # Parse command line arguments
    parser = argparse.ArgumentParser(description='Run tasks from a JSONL file for SCoRe data generation')
    parser.add_argument('--config', type=str, default='configs/SCoRe_data_gen_config.yaml',
                        help='Path to the configuration file (default: configs/SCoRe_data_gen_config.yaml)')
